THE DONALD - a new playable character for Slay the Spire 2
============================================================
...
UNINSTALL
  ...
  If a run in progress (or run history) uses The Donald, the uninstaller starts the game for a few
  seconds so the mod can remove those saves locally and from Steam Cloud (backups are kept in
  %APPDATA%\SlayTheSpire2\trump_character_uninstall_backup). Then it deletes the mod.
