...
public partial class NTrumpCombatUi : Node
{
	...
	private const string StampArt = TrumpArt.Dir + "ui/deport_stamp.png";
	...
	{
		if (TrumpArt.Load(StampArt) is Texture2D art)
		{
	...
	private static void SlamStamp(NCombatRoom room, NCreature node)
	{
		...
		if (TrumpArt.Load(StampArt) is not Texture2D art)
		{
			return;
		}
