...
using TrumpMod.Models.PotionPools;
using TrumpMod.Models.RelicPools;
using TrumpMod.Models.Relics;

namespace TrumpMod.Models.Characters;
...
/// Stats and deck are Step 2 placeholders; real values come from the design doc.
/// </summary>
public sealed class Trump : CharacterModel, IModCharacter
{
	...
	public override IEnumerable<CardModel> StartingDeck => new CardModel[]
	{
		...
		ModelDb.Card<DefendTrump>(),
		ModelDb.Card<DefendTrump>(),
		ModelDb.Card<DeportPrototype>()
	};

	public override IReadOnlyList<RelicModel> StartingRelics => new RelicModel[] { ModelDb.Relic<PlaceholderRelicTrump>() };
