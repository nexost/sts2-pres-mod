...
/// which is before LocManager and ModelDb initialize. One mod, several characters: everything that isn't a
/// character's own content lives in Framework/ and Dev/, each character in Characters/&lt;Name&gt;/ (docs/FRAMEWORK.md).
/// </summary>
[ModInitializer(nameof(Initialize))]
public static class ModEntry
{
	public const string ModId = "pres_mod";
