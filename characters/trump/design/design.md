...
**make deals**. Everything below is designed against numbers mined from the five base characters ([`docs/reference/base_game_benchmarks.md`](../../../docs/reference/base_game_benchmarks.md)).

- Full card list with every number: [`card_list.md`](card_list.md)
