...
| **Sleepy Joe** (Joe Biden): dozes off, rambles, wakes up as Dark Brandon | `biden` | In progress (branch `feature/biden`): all 88 cards, relics, potions and text playable; placeholder art; balance next | [`characters/biden/`](characters/biden/) |
